...
// Mark the topics/posts in a forum as read?
    ...
    <div class="main-content">
        <div class="ct-box" style="max-width: 32px;">
            <?php
            ...
            foreach ($smiley_groups as $smiley_img => $smiley_texts) {
                ?>
                <a href="javascript:insert_text('<?php echo $smiley_texts['0'] ?>', '');"><img src="<?php echo $base_url ?>/resources/editor/emoticons/<?php echo $smiley_img ?>" alt="<?php echo $smiley_texts['0'] ?>" title="<?php echo $smiley_texts['0'] ?>"/></a>
                <?php
            }
            ?>
        </div>
