...
if ($forum_config['p_enable_bb_panel'] && $forum_user['show_bb_panel'])
{
	...
	$forum_js->file(array('jquery', 'material', 'flazy', 'common', 'bb'));
	$url_bl = '';
	...
	foreach ($bbcode as $bb_type => $bb_text)
		$forum_page['bb_code'][] = '<a type="submit" onclick="'.$bb_text['0'].'">'.$bb_type.'</a>';
...
?>
                                        ...
                                        <div id="format-buttons" class="col s12 m12 l12">
						<?php echo implode("\n\t\t\t\t\t\t", $forum_page['bb_code'])."\n"; ?>
					</div>
