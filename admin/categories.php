...
<div class="box">
	<div class="box-header with-border">
		<h3 class="box-title"><?php printf($lang_admin_categories['Confirm delete cat'], forum_htmlencode($cat_name)) ?></h3>
	...
	<div class="box-body">
		<div class="alert alert-danger">
			<?php echo $lang_admin_categories['Delete category warning'] ?>
		</div>
	</div><!-- /.box-body -->
	<div class="box-footer">
		<form class="frm-form" method="post" accept-charset="utf-8" action="<?php echo $forum_page['form_action'] ?>">
			...
			<div class="frm-buttons">
				<input type="submit" class="btn btn-danger" name="del_cat_comply" value="<?php echo $lang_admin_categories['Delete category'] ?>" />
				<input type="submit" class="btn btn-info" name="del_cat_cancel" value="<?php echo $lang_admin_common['Cancel'] ?>" />
			</div>
		</form>
	</div><!-- /.box-footer-->
</div>
...
<table id="gc<?php echo ++$forum_page['group_count'] ?>" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
	...
	<?php ($hook = get_hook('acg_pre_edit_cat_name')) ? eval($hook) : null; ?>
		<tr role="row">
			<th rowspan="1" colspan="1"><?php echo $lang_admin_categories['Category name label'] ?></th>
			<th rowspan="1" colspan="1"><?php echo $lang_admin_categories['Position label'] ?></th>
		</tr>
	</thead>
<?php ($hook = get_hook('acg_pre_edit_cat_position')) ? eval($hook) : null; ?>
	<tbody class="gc1">								
		<tr role="row" class="set1 mf-head">
			<td><input type="text" id="fld<?php echo $forum_page['fld_count'] ?>" name="cat_name[<?php echo $cur_category['id'] ?>]" value="<?php echo forum_htmlencode($cur_category['cat_name']) ?>" size="35" maxlength="80" class="form-control input-md" ></td>
			<td><input type="text" id="fld<?php echo $forum_page['fld_count'] ?>" name="cat_order[<?php echo $cur_category['id'] ?>]" value="<?php echo $cur_category['disp_position'] ?>" size="3" maxlength="3" class="form-control input-md" ></td>
		</tr>
	</tbody>
</table>
