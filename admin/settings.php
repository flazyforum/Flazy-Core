...
<div class="form-group ic<?php echo ++$forum_page['item_count'] ?>">
  <label class="col-md-4 control-label" for="fld<?php echo $forum_page['fld_count'] ?>"><?php echo $lang_admin_settings['Compose rules label'] ?></label>
  <div class="col-md-4">                     
    <textarea class="form-control" id="fld<?php echo $forum_page['fld_count'] ?>" name="form[rules_message]" rows="10" cols="55"><?php echo forum_htmlencode($forum_config['o_rules_message']) ?></textarea>
    <span class="help-block"><?php echo $lang_admin_settings['Compose rules help'] ?></span>
  </div>
</div>
<?php ($hook = get_hook('aop_fl_registration_pre_rules_fieldset_end')) ? eval($hook) : null; ?>
			</fieldset>
