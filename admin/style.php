...
<link rel="stylesheet" src="https://flazy.mgknet.com/resources/admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.css"  type="text/css"/>
    ...
    <!-- AdminLTE App -->
    <script src="<?php echo $base_url  ?>/resources/admin/dist/js/app.min.js" type="text/javascript"></script>
    <!-- SlimScroll 1.3.0 -->
    <script src="<?php echo $base_url  ?>/resources/admin/plugins/slimScroll/jquery.slimscroll.min.js" type="text/javascript"></script>
