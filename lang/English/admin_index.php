...
/**
 * English Language.
 * @package Flazy_English
 */
$lang_admin_index = array(

'Information head'				=>	'Welcome to Flazy administration control panel',
'Alerts'						=>	'Administrator Alerts',
'Alerts success'				=>	'Success',
'Check for updates enabled'		=>	'This board is setup to automatically check for updates and hotfixes against the updates.flazy.us updates service.',
'Check for updates'				=>	'Check for updates', // Link text
'Copyright message'				=>	'&copy; 2013-2015 <a href="https://flazy.us/">Flazy</a>, based on &copy; 2008-2015 <a href="http://punbb.informer.com/">PunBB</a>, and &copy; 2008-2015 <a href="http://fluxbb.org/">FluxBB</a>',
'Flazy version'					=>	'Flazy version',
...
// Предупреждения
/*RUS*/'Maintenance alert'		=>	'<strong>WARNING! Maintenance mode enabled.</strong> This board is currently in maintenance mode. <em>DO NOT</em> logout, if you do you will not be able to login again.',
'Updates'						=>	'Flazy updates:',
...
'Deleted install.php'			=>	'The file was successfully removed.',
'Delete install.php failed'		=>	'Could not remove install.php. Please do it manually .',
);