...
/*RUS*/'Report off'				=>	'Запрещено отправлять жалобы.',
...
/*RUS*/'Report help'				=>	'Отправте жалобу по этому сообщению администратору и/или модератору форума',
'Reason'					=>	'Reason',
...
/*RUS*/'Merge poll error'			=>	'Вы не можите объеденить эти темы, так как 2 или больше тем включают голосование. Удалите голосование перед объединением.',
...
/*RUS*/'Perform conversion'		=>	'Преобразовать БД',
/*RUS*/'Perform conversion label'	=>	'Выполнить преобразование подсистемы низкого уровня с %1$s на %2$s.',
/*RUS*/'Conversion successful'		=>	'Подсистема преобразована с %1$s на %2$s. Перенаправление…',
/*RUS*/'Conversion not supported'	=>	'Часть базы данных не поддерживает выбраную подсистему.',
/*RUS*/'Already converted'			=>	'База данных уже использует рекомендованую подсистему.'
