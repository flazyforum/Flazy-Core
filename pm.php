...
if (isset($_POST['form_sent'])) {
    ...
    if (isset($_POST['draft'])) {
        ...
        else if (!$forum_config['p_message_all_caps'] && check_is_all_caps($message) && !$forum_user['is_admmod'])
    ...
    if (isset($cur_message['id']) && $type == 'inbox') {
        ...
        <div class="main-content main-frm">
            ...
            if (substr($cur_message['subject'], 0, 4) == 'Ответ: ')
                $cur_message['subject'] = 'Oтвет[2]: ' . utf8_substr($cur_message['subject'], 4);

            $subject_reply = preg_replace('#^Ответ\[(\d{1,10})\]: #u', '\'Ответ[\'.(\\1 + 1).\']: \'', $cur_message['subject']);
