...
(function(A) {
    A.extend(A.fn, {
        pstrength: function(B) {
            var B = A.extend({
                verdects: ["Very easy", "Easy", "Medium", "Difficult", "Very difficult"],
                colors: ["#f00", "#c06", "#f60", "#3c0", "#4caf50"],
                scores: [10, 15, 30, 40],
                common: ["password", "1234", "qwerty", "abc123", "monkey", "gfhjkm", "sexy", "black"],
                minchar: 4
            }, B);
